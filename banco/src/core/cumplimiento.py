...
AVISOS = {
    ...
    # No ofrece pasarte con una persona: ese disparador es el
    # Ejercicio 12.2, y lo que se firma abajo con sha256 tiene que
    # ser lo que el código hace.
    "chat": ("Hablas con un asistente automático del banco: no es "
             "una persona. Puede equivocarse, y no decide nada "
             "sobre tu dinero por sí mismo."),
    "voz": ("Le atiende el asistente virtual del banco. "
    ...
    "avatar": ("Le atiende el asistente virtual del banco. "
               "Soy una inteligencia artificial: la "
...
def anotar(tipo: str, canal: str, sujeto: str, cur=None,
    ...
    sql = ("INSERT INTO banco.registro_ia"
