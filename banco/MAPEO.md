...
Libro de origen: 13819 lineas. 72 ficheros, 89 entradas de mapeo.

| Fichero | Modulo | Modo | Lineas del libro | Nota |
|---|---|---|---|---|
| `src/core/memoria.sql` | M34.7 | verbatim | L11122-11212 | Entregado del M34.7. |
...
| `src/core/supresion.py` | M34.7 | verbatim | L11646-11850 | Entregado del M34.7. |
...
| `src/core/hitl.py` | M35.6 | verbatim | L12105-12381 | Entregado del M35.6. |
...
| `src/evals/trayectoria.py` | M25.7 | verbatim | L8722-8794 | Entregado del M25.7. |
| `src/evals/trayectoria.py` | M25.7 | patch | L8802-8877 | Anadido del M25.7. |
| `src/rag/trocear.py` | M7.3 | verbatim | L2144-2372 | Entregado del M7.3. |
| `src/channels/confianza.py` | M22.5 | verbatim | L7667-7757 | Entregado del M22.5. |
| `src/agents/handoff.py` | M23.5 | verbatim | L8000-8149 | Entregado del M23.5. |
| `src/rag/gobierno.sql` | M24.6 | verbatim | L8379-8441 | Entregado del M24.6. |
| `src/rag/gobierno.py` | M24.6 | verbatim | L8449-8571 | Entregado del M24.6. |
| `config/politica.yaml` | M26.2 | verbatim | L8992-9038 | Entregado del M26.2. |
| `src/ops/migrar_checkpoints.py` | M27.4 | verbatim | L9331-9468 | Entregado del M27.4. |
| `runbooks/deriva.py` | M28.5 | verbatim | L9714-9803 | Entregado del M28.5. |
| `src/finops/coste_por_resolucion.py` | M29.4 | verbatim | L9905-10092 | Entregado del M29.4. |
| `equipo.yaml` | M30.5 | verbatim | L10207-10262 | Entregado del M30.5. |
| `equipo.py` | M30.5 | verbatim | L10273-10362 | Entregado del M30.5. |
| `src/core/trabajos.py` | M21.5 | verbatim | L7307-7508 | Entregado del M21.5. |
| `src/core/politica.py` | M26.5 | verbatim | L9089-9214 | Entregado del M26.5. |
| `plataforma/estado.py` | M32.2 | verbatim | L10557-10590 | Un pool, un checkpointer y un store para toda la plataforma: el estado deja de ser de cada agente. |
| `plataforma/registro.py` | M32.3 | verbatim | L10645-10689 | El control plane resolviendo un id a paquete y fabrica. Sin publicacion no hay produccion. |
| `plataforma/catalogo.py` | M33.6 | verbatim | L10848-10917 | El resolutor del catalogo compartido: seleccion dinamica por contexto y permisos, con el sello que invalida la cache. |
| `plataforma/trazas.py` | M36.6 | verbatim | L12576-12638 | El esquema de traza del 36.1 como codigo: la unidad de observacion de una flota es la decision, no la CPU. |
...
| `db/schema.sql` | M21.5 | patch | L7516-7557 | banco.trabajos y banco.efectos (cola con leases y libro mayor de la saga). El libro dice literalmente que van al final del db/schema.sql del 7.6. |
| `db/schema.sql` | M35.6 | patch | L12392-12442 | banco.aprobaciones (la cola de aprobaciones con su receipt firmado). El libro dice literalmente que va al final del db/schema.sql del 7.6, junto a banco.trabajos. |
| `db/schema.sql` | M34.7 | patch | L11220-11284 | banco.supresiones y los cuatro ALTER de la supresion RGPD (aprobaciones, manuales, registro_ia). Va detras de aprobaciones: sus ALTER la necesitan creada. |
...
| `src/agents/supervisor/supervisor.py` | M23.5 | patch | L8166-8247 | Anadido del M23.5. |
...
| `deploy/despliegue-chat.yaml` | M27.2 | patch | L9286-9305 | Anadido del M27.2. |
...
| `src/core/contratos.py` | M22.3 | patch | L7636-7651 | HumanHandoffPacket: el escalado a humano como producto. Trae sus imports repetidos, tal cual estan en el libro. |
| `src/core/contratos.py` | M23.1 | patch | L7928-7942 | HandoffContract y su campo authority: la frontera entre agentes. |
| `src/core/memoria.py` | M34.1 | verbatim | L10990-11005 | MemoryRecord: sin owner, sensibilidad, TTL y procedencia no hay memoria gobernada. |
| `src/core/memoria.py` | M34.7 | patch | L11292-11415 | Anadido del M34.7. |
| `src/core/memoria.py` | M34.7 | patch | L11419-11638 |  |
...
| `.github/workflows/agent-evals.yml` | M25.5 | verbatim | L8684-8697 | Extracto conceptual, igual que en el libro: no es un workflow completo. |
| `aceptacion.py` | M31.2 | verbatim | L10420-10461 | La puerta del capstone: seis medidas, semilla, pases e intervalo, con el veredicto NO CONCLUYENTE. |
| `catalogo/cards-disputes/agent.yaml` | M32.3 | verbatim | L10607-10633 | Agent Package publicable. Valida contra schemas/agent-package.schema.json. |
| `plataforma/runtime.py` | M37.2 | verbatim | L12699-12852, L12863-12983 | Nadie importa un grafo: se pide por id, con el sello del catalogo en la clave de la cache. La politica y el HITL van en el mismo wrap_tool_call. |
