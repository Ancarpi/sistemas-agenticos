...
Libro de origen: 14165 lineas. 73 ficheros, 89 entradas de mapeo.

| Fichero | Modulo | Modo | Lineas del libro | Nota |
|---|---|---|---|---|
| `src/core/memoria.sql` | M34.7 | verbatim | L11317-11399 | Entregado del M34.7. |
...
| `src/core/supresion.py` | M34.7 | verbatim | L11834-11863, L11871-11933, L11941-12000, L12008-12065 | Entregado del M34.7. |
...
| `src/core/hitl.py` | M35.6 | verbatim | L12287-12359, L12367-12453, L12461-12553, L12561-12628 | Entregado del M35.6. |
...
| `src/evals/trayectoria.py` | M25.7 | verbatim | L8855-8927 | Entregado del M25.7. |
| `src/evals/trayectoria.py` | M25.7 | patch | L8935-9010 | Anadido del M25.7. |
| `src/rag/trocear.py` | M7.3 | verbatim | L2176-2404 | Entregado del M7.3. |
| `src/channels/confianza.py` | M22.5 | verbatim | L7779-7870 | Entregado del M22.5. |
| `src/agents/handoff.py` | M23.5 | verbatim | L8113-8262 | Entregado del M23.5. |
| `src/rag/gobierno.sql` | M24.6 | verbatim | L8512-8574 | Entregado del M24.6. |
| `src/rag/gobierno.py` | M24.6 | verbatim | L8582-8704 | Entregado del M24.6. |
| `config/politica.yaml` | M26.2 | verbatim | L9125-9171 | Entregado del M26.2. |
| `src/ops/migrar_checkpoints.py` | M27.4 | verbatim | L9493-9630 | Entregado del M27.4. |
| `runbooks/deriva.py` | M28.5 | verbatim | L9876-9965 | Entregado del M28.5. |
| `src/finops/coste_por_resolucion.py` | M29.4 | verbatim | L10075-10274 | Entregado del M29.4. |
| `equipo.yaml` | M30.5 | verbatim | L10396-10452 | Entregado del M30.5. |
| `equipo.py` | M30.5 | verbatim | L10463-10552 | Entregado del M30.5. |
| `src/core/trabajos.py` | M21.5 | verbatim | L7419-7620 | Entregado del M21.5. |
| `src/core/politica.py` | M26.5 | verbatim | L9251-9376 | Entregado del M26.5. |
| `plataforma/estado.py` | M32.2 | verbatim | L10751-10784 | Un pool, un checkpointer y un store para toda la plataforma: el estado deja de ser de cada agente. |
| `plataforma/registro.py` | M32.3 | verbatim | L10839-10883 | El control plane resolviendo un id a paquete y fabrica. Sin publicacion no hay produccion. |
| `plataforma/catalogo.py` | M33.6 | verbatim | L11042-11112 | El resolutor del catalogo compartido: seleccion dinamica por contexto y permisos, con el sello que invalida la cache. |
| `plataforma/trazas.py` | M36.6 | verbatim | L12829-12891 | El esquema de traza del 36.1 como codigo: la unidad de observacion de una flota es la decision, no la CPU. |
...
| `db/schema.sql` | M35.6 | patch | L12636-12695 | banco.aprobaciones (la cola de aprobaciones con su receipt firmado). El libro dice literalmente que va al final del db/schema.sql del 7.6, junto a banco.trabajos. |
| `db/schema.sql` | M34.7 | patch | L11407-11456 | banco.supresiones y los cuatro ALTER de la supresion RGPD (aprobaciones, manuales, registro_ia). Va detras de aprobaciones: sus ALTER la necesitan creada. |
...
| `src/agents/supervisor/supervisor.py` | M23.5 | patch | L8279-8360 | Anadido del M23.5. |
...
| `deploy/despliegue-chat.yaml` | M27.2 | patch | L9448-9467 | Anadido del M27.2. |
...
| `tools/operar_contabilidad_z.capability.yaml` | M26.3 | verbatim | L9204-9225 | El manifiesto de computer use del 26.3: la capacidad operar-aplicacion con su risk_tier y su step budget. |
...
| `src/core/contratos.py` | M23.1 | patch | L8041-8055 | HandoffContract y su campo authority: la frontera entre agentes. |
| `src/core/memoria.py` | M34.1 | verbatim | L11185-11200 | MemoryRecord: sin owner, sensibilidad, TTL y procedencia no hay memoria gobernada. |
| `src/core/memoria.py` | M34.7 | patch | L11464-11584 | Anadido del M34.7. |
| `src/core/memoria.py` | M34.7 | patch | L11588-11632, L11640-11724, L11732-11770, L11778-11826 |  |
...
| `.github/workflows/agent-evals.yml` | M25.5 | verbatim | L8817-8830 | Extracto conceptual, igual que en el libro: no es un workflow completo. |
| `aceptacion.py` | M31.2 | verbatim | L10610-10651 | La puerta del capstone: seis medidas, semilla, pases e intervalo, con el veredicto NO CONCLUYENTE. |
| `catalogo/cards-disputes/agent.yaml` | M32.3 | verbatim | L10801-10827 | Agent Package publicable. Valida contra schemas/agent-package.schema.json. |
| `plataforma/runtime.py` | M37.2 | verbatim | L12961-13125, L13136-13258 | Nadie importa un grafo: se pide por id, con el sello del catalogo en la clave de la cache. La politica y el HITL van en el mismo wrap_tool_call. |
