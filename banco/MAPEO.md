...
Libro de origen: 12546 lineas. 68 ficheros, 78 entradas de mapeo.
...
| `src/rag/trocear.py` | M7.3 | verbatim | L2060-2162 | Entregado del M7.3. |
...
| `src/core/politica.py` | M26.5 | verbatim | L8786-8870 | Entregado del M26.5. |
...
| `src/core/models.py` | M0.4 | verbatim | L219-231 | La fabrica get_model()/get_embeddings(). Ruta obligada por el Ejercicio 0.1: de ella tira el resto del libro. |
...
| `src/agents/backoffice/agente_backoffice.py` | M4.3 | verbatim | L1161-1166 | El nano_agent industrializado: middleware, interrupt_on y checkpointer. |
...
| `src/agents/voz/grafo_voz.py` | M13.4 | verbatim | L4597-4604 | El cerebro de la llamada: dos herramientas y wrap_tool_call. |
...
| `src/core/memoria.py` | M34.5 | patch | L10718-10726 | PENDIENTE. Las tres APIs tipadas de memoria con sus receipts: los cuerpos son ... y los tres tipos de receipt no existen todavia, asi que el modulo no importa hasta que los escribas. |
...
| `plataforma/runtime.py` | M37.2 | verbatim | L11450-11603, L11614-11700 | Nadie importa un grafo: se pide por id, con el sello del catalogo en la clave de la cache. La politica y el HITL van en el mismo wrap_tool_call. |
