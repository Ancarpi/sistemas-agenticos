...
Libro de origen: 13593 lineas. 72 ficheros, 86 entradas de mapeo.

| Fichero | Modulo | Modo | Lineas del libro | Nota |
|---|---|---|---|---|
| `src/core/memoria.sql` | M34.7 | verbatim | L10976-11066 | Entregado del M34.7. |
| `tests/test_registro.py` | M16.7 | verbatim | L5872-5900 | Entregado del M16.7. |
| `tests/test_art50.py` | M16.7 | verbatim | L5852-5868 | Anadido del M16.7. |
| `src/core/supresion.py` | M34.7 | verbatim | L11475-11669 | Entregado del M34.7. |
...
| `src/core/hitl.py` | M35.6 | verbatim | L11924-12172 | Entregado del M35.6. |
| `src/core/router.py` | M19.6 | verbatim | L6547-6679 | Entregado del M19.6. |
| `src/core/catalogo_tools.py` | M20.6 | verbatim | L6947-7089 | Entregado del M20.6. |
| `src/evals/trayectoria.py` | M25.7 | verbatim | L8603-8675 | Entregado del M25.7. |
| `src/evals/trayectoria.py` | M25.7 | patch | L8683-8758 | Anadido del M25.7. |
| `src/rag/trocear.py` | M7.3 | verbatim | L2101-2323 | Entregado del M7.3. |
| `src/channels/confianza.py` | M22.5 | verbatim | L7565-7655 | Entregado del M22.5. |
| `src/agents/handoff.py` | M23.5 | verbatim | L7898-8047 | Entregado del M23.5. |
| `src/rag/gobierno.sql` | M24.6 | verbatim | L8260-8322 | Entregado del M24.6. |
| `src/rag/gobierno.py` | M24.6 | verbatim | L8330-8452 | Entregado del M24.6. |
| `config/politica.yaml` | M26.2 | verbatim | L8873-8919 | Entregado del M26.2. |
| `src/ops/migrar_checkpoints.py` | M27.4 | verbatim | L9212-9343 | Entregado del M27.4. |
| `runbooks/deriva.py` | M28.5 | verbatim | L9589-9678 | Entregado del M28.5. |
| `src/finops/coste_por_resolucion.py` | M29.4 | verbatim | L9776-9963 | Entregado del M29.4. |
| `equipo.yaml` | M30.5 | verbatim | L10078-10133 | Entregado del M30.5. |
| `equipo.py` | M30.5 | verbatim | L10144-10233 | Entregado del M30.5. |
| `src/core/trabajos.py` | M21.5 | verbatim | L7210-7406 | Entregado del M21.5. |
| `src/core/politica.py` | M26.5 | verbatim | L8970-9095 | Entregado del M26.5. |
| `plataforma/estado.py` | M32.2 | verbatim | L10428-10461 | Un pool, un checkpointer y un store para toda la plataforma: el estado deja de ser de cada agente. |
| `plataforma/registro.py` | M32.3 | verbatim | L10516-10559 | El control plane resolviendo un id a paquete y fabrica. Sin publicacion no hay produccion. |
| `plataforma/catalogo.py` | M33.6 | verbatim | L10718-10783 | El resolutor del catalogo compartido: seleccion dinamica por contexto y permisos, con el sello que invalida la cache. |
| `plataforma/trazas.py` | M36.6 | verbatim | L12365-12427 | El esquema de traza del 36.1 como codigo: la unidad de observacion de una flota es la decision, no la CPU. |
...
| `src/agents/supervisor/supervisor.py` | M23.5 | patch | L8064-8132 | Anadido del M23.5. |
...
| `src/channels/backend/batch_nocturno.py` | M17.2 | patch | L6140-6153 | PENDIENTE. Apagado ordenado por SIGTERM: el libro lo pega justo encima de main(), y la condicion del bucle de tandas pasa a mirar PARANDO. |
...
| `src/channels/chat/servidor.py` | M17.2 | patch | L6009-6058 | Sondas de liveness y readiness con cache de 5 s. Esta si se pega al final, como dice el libro. |
| `src/channels/chat/servidor.py` | M17.2 | patch | L6116-6132 | PENDIENTE. Lifespan y apagado ordenado: SUSTITUYE al FastAPI() del 12.5. Pegado al final reasigna api y el canal se queda sin rutas. |
...
| `deploy/despliegue-chat.yaml` | M17.2 | verbatim | L5968-6001 | El servidor.py del 12.5 en un cluster: sondas, preStop y gracia de 120 s. |
| `deploy/despliegue-chat.yaml` | M27.2 | patch | L9167-9186 | Anadido del M27.2. |
| `deploy/autoescalado.yaml` | M17.2 | verbatim | L6072-6102 | KEDA por profundidad de cola, nunca por CPU. |
| `src/core/identidad.py` | M18.3 | verbatim | L6272-6316 | Quien es el hilo: dos funciones separan cinco canales de cinco sistemas. |
| `src/core/context_contracts.py` | M19.1 | verbatim | L6417-6447 | El ContextContract y el contrato de triaje. Valida contra schemas/context-contract.schema.json. |
| `config/model_routing.yaml` | M19.2 | verbatim | L6469-6490 | Politica de routing por tarea, con presupuesto de pensamiento y de coste. |
| `config/model_routing.yaml` | M19.6 | patch | L6687-6703 | Anadido del M19.6. |
| `tools/bloquear_tarjeta.capability.yaml` | M20.1 | verbatim | L6757-6806 | Tool Capability Manifest. Valida contra schemas/tool-capability.schema.json. |
| `src/agents/cards_disputes/herramientas.py` | M20.2 | verbatim | L6823-6869 | read-plan-dry-run-commit con clave de idempotencia y outbox. Es el entrypoint que declara catalogo/cards-disputes/agent.yaml. |
| `src/core/contratos.py` | M20.3 | verbatim | L6887-6912 | ToolError tipado: el error como lenguaje de coordinacion, devuelto como ToolMessage y nunca como excepcion cruda. |
| `src/core/contratos.py` | M22.3 | patch | L7534-7549 | HumanHandoffPacket: el escalado a humano como producto. Trae sus imports repetidos, tal cual estan en el libro. |
| `src/core/contratos.py` | M23.1 | patch | L7826-7840 | HandoffContract y su campo authority: la frontera entre agentes. |
| `src/core/memoria.py` | M34.1 | verbatim | L10852-10867 | MemoryRecord: sin owner, sensibilidad, TTL y procedencia no hay memoria gobernada. |
| `src/core/memoria.py` | M34.7 | patch | L11146-11264 | Anadido del M34.7. |
| `src/core/memoria.py` | M34.7 | patch | L11268-11467 |  |
...
| `.github/workflows/agent-evals.yml` | M25.5 | verbatim | L8565-8578 | Extracto conceptual, igual que en el libro: no es un workflow completo. |
| `aceptacion.py` | M31.2 | verbatim | L10291-10332 | La puerta del capstone: seis medidas, semilla, pases e intervalo, con el veredicto NO CONCLUYENTE. |
| `catalogo/cards-disputes/agent.yaml` | M32.3 | verbatim | L10478-10504 | Agent Package publicable. Valida contra schemas/agent-package.schema.json. |
| `plataforma/runtime.py` | M37.2 | verbatim | L12488-12641, L12652-12761 | Nadie importa un grafo: se pide por id, con el sello del catalogo en la clave de la cache. La politica y el HITL van en el mismo wrap_tool_call. |
